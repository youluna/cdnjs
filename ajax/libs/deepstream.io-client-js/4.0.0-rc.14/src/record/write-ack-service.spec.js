...
describe('Write Ack Notifier', function () {
    ...
    var action = message_constants_1.RECORD_ACTIONS.CREATEANDPATCH;
    var ackAction = message_constants_1.RECORD_ACTIONS.CREATEANDPATCH_WITH_WRITE_ACK;
    var name = 'record';
    var services;
    var writeAckService;
    var callbackSpy;
    ...
    it('cant\'t send request when client is offline', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    it('calls callbacks with error message when connection is lost', function () { return __awaiter(_this, void 0, void 0, function () {
        var messageBody;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    describe('receiving', function () {
        ...
        it('logs error for unknown acknowledgements', function () { return __awaiter(_this, void 0, void 0, function () {
            var msg;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('calls ack callback when server sends ack message', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('doesn\'t call callback twice', function () { return __awaiter(_this, void 0, void 0, function () {
            var msg;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('calls ack callback with error when server sends error message', function () { return __awaiter(_this, void 0, void 0, function () {
            var errorAction;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        errorAction = message_constants_1.RECORD_ACTIONS.MESSAGE_DENIED;
                        writeAckService.recieve({
                            topic: topic,
                            action: errorAction,
                            correlationId: correlationId,
