...
describe('Presence handler', () => {
    ...
    let promiseSuccess;
    let promiseError;
    const options = Object.assign({}, client_options_1.DefaultOptions, { subscriptionInterval: 10 });
    let counter;
    beforeEach(() => {
    ...
    it('can\'t query getAll when client is offline', () => __awaiter(this, void 0, void 0, function* () {
    ...
    it('subscribes to presence with user a', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield bluebird_1.Promise.delay(options.subscriptionInterval * 2);
    }));
    ...
    it('sends unsubscribe for specific user presence', () => __awaiter(this, void 0, void 0, function* () {
        const user = 'user';
        const subMsg = { topic: message_constants_1.TOPIC.PRESENCE, action: message_constants_1.PRESENCE_ACTIONS.SUBSCRIBE_BULK, names: [user], correlationId: '0' };
        const unsubMsg = { topic: message_constants_1.TOPIC.PRESENCE, action: message_constants_1.PRESENCE_ACTIONS.UNSUBSCRIBE_BULK, names: [user], correlationId: '1' };
        services.connectionMock
            .expects('sendMessage')
            .once()
...
//# sourceMappingURL=presence-handler.spec.js.map