...
var Helmet = function Helmet(Component) {
    ...
    return _temp = _class = function (_React$Component) {
        ...
        _createClass(HelmetWrapper, [{
            ...
            value: function flattenArrayTypeChildren(_ref2) {
                var child = _ref2.child,
                    arrayTypeChildren = _ref2.arrayTypeChildren,
            ...
            value: function mapObjectTypeChildren(_ref3) {
                var _extends3;

                var child = _ref3.child,
                    newProps = _ref3.newProps,
                    newChildProps = _ref3.newChildProps,
            ...
            value: function warnOnInvalidChildren(child, nestedChildren) {
                if (process.env.NODE_ENV !== "production" && nestedChildren && typeof nestedChildren !== "string") {
