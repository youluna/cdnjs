...
var updateAttributes = function updateAttributes(tagName, attributes) {
    ...
    if (helmetAttributes.length === attributesToRemove.length) {
        ...
        elementTag.setAttribute(_HelmetConstants.HELMET_ATTRIBUTE, helmetAttributes.join(","));
    }
};
...
var generateTitleAsString = function generateTitleAsString(type, title, attributes) {
    ...
    return attributeString ? "<" + type + " " + _HelmetConstants.HELMET_ATTRIBUTE + "=\"true\" " + attributeString + ">" + encodeSpecialCharacters(title) + "</" + type + ">" : "<" + type + " " + _HelmetConstants.HELMET_ATTRIBUTE + "=\"true\">" + encodeSpecialCharacters(title) + "</" + type + ">";
};
