...
function cloudinaryjquery_createSuper(Derived) { return function () { var Super = cloudinaryjquery_getPrototypeOf(Derived), result; if (cloudinaryjquery_isNativeReflectConstruct()) { var NewTarget = cloudinaryjquery_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return cloudinaryjquery_possibleConstructorReturn(this, result); }; }
