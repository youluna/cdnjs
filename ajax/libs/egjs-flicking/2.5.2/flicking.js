  ...
  function () {
    ...
    function (_Mixin$with) {
      ...
      */
      ...
      _proto._setDefaultPanel = function _setDefaultPanel(index, isRebuild) {
        var panel = this._conf.panel;
        var lastIndex = panel.count - 1;
        var isValidIndex = (!isRebuild && index > 0 || isRebuild && index >= 0) && index <= lastIndex;
        var coords;
        var baseIndex;
