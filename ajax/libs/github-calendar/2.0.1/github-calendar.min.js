  ...
  return function o(u, s, i) {
    function c(t, e) {
      if (!s[t]) {
        ...
        }var a = s[t] = { exports: {} };u[t][0].call(a.exports, function (e) {
          return c(u[t][1][e] || e);
        }, a, a.exports, o, u, s, i);
      }return s[t].exports;
      ...
      var b = e("github-calendar-parser"),
        ...
        p = m(p), (g = g || {}).summary_text = g.summary_text || 'Summary of pull requests, issues opened, and commits made by <a href="https://github.com/' + e + '" target="blank">@' + e + "</a>", g.cache = 1e3 * (g.cache || 86400), !1 === g.global_stats && (p.style.minHeight = "175px");var r = "gh_calendar_content",
          ...
          return fetch("http://api.bloggify.net/gh-calendar/?username=" + e).then(function (e) {
            return e.text();
          });
          ...
          return g.getCalendar(e).then(function (e) {
            var t = document.createElement("div");t.innerHTML = e;var r = t.querySelector(".js-yearly-contributions");if (m(".position-relative h2", r).remove(), r.querySelector(".float-left.text-gray").innerHTML = g.summary_text, r.querySelector("include-fragment")) setTimeout(f, 500);else {
              if (!0 === g.responsive) {
                ...
                var u = b(m("svg", r).outerHTML),
                    s = u.current_streak ? y(u.current_streak_range[0], M) + " &ndash; " + y(u.current_streak_range[1], M) : u.last_contributed ? "Last contributed in " + y(u.last_contributed, M) + "." : "Rock - Hard Place",
                    i = u.longest_streak ? y(u.longest_streak_range[0], M) + " &ndash; " + y(u.longest_streak_range[1], M) : u.last_contributed ? "Last contributed in " + y(u.last_contributed, M) + "." : "Rock - Hard Place",
      ...
      var n = e("months"),
          ...
          return a.abbr[s.d(e, t)];
        }, dd: function dd(e, t) {
          return a.short[s.d(e, t)];
        }, d: function d(e, t) {
          ...
          return o(s.s(e, t) / 60 * 100);
        }, SSS: function SSS(e, t) {
          return o(s.s(e, t) / 60 * 1e3, 3);
        }, Z: function Z(e) {
          var t = -e.getTimezoneOffset();return (0 <= t ? "+" : "-") + o(parseInt(t / 60)) + ":" + o(t % 60);
        }, ZZ: function ZZ(e) {
          var t = -e.getTimezoneOffset();return (0 <= t ? "+" : "-") + o(parseInt(t / 60)) + o(t % 60);
        } },
          i = new u(s);t.exports = function (e, t) {
      ...
      var i = e("github-calendar-legend");t.exports = function (e) {
        function o() {
          u.current_streak > u.longest_streak && (u.longest_streak = u.current_streak, u.longest_streak_range[0] = u.current_streak_range[0], u.longest_streak_range[1] = u.current_streak_range[1]);
        }var u = { last_year: 0, longest_streak: -1, longest_streak_range: [], current_streak: 0, current_streak_range: [], weeks: [], days: [], last_contributed: null },
            s = [];return e.split("\n").slice(2).map(function (e) {
          return e.trim();
        }).forEach(function (e) {
          if (e.startsWith("<g transform")) return s.length && u.weeks.push(s) && (s = []);var t = e.match(/fill="(#[a-z0-9]+)"/),
              r = e.match(/data-date="([0-9\-]+)"/),
              n = e.match(/data-count="([0-9]+)"/);if (t = t && t[1], r = r && r[1], n = n && +n[1], t) {
            var a = { fill: t, date: new Date(r), count: n, level: i.indexOf(t) };0 === u.current_streak && (u.current_streak_range[0] = a.date), a.count ? (++u.current_streak, u.last_year += a.count, u.last_contributed = a.date, u.current_streak_range[1] = a.date) : (o(), u.current_streak = 0), s.push(a), u.days.push(a);
          }
        }), o(), u;
      };
