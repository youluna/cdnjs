...
var makeStyleTag = function makeStyleTag(target, tagEl, insertBefore) {
  ...
  el.setAttribute(SC_VERSION_ATTR, "4.3.1-0");
...
var wrapAsHtmlTag = function wrapAsHtmlTag(css, names) {
  return function (additionalAttrs) {
    var nonce = getNonce();
    var attrs = [nonce && 'nonce="' + nonce + '"', SC_ATTR + '="' + stringifyNames(names) + '"', SC_VERSION_ATTR + '="' + "4.3.1-0" + '"', additionalAttrs];
...
var wrapAsElement = function wrapAsElement(css, names) {
  return function () {
    ...
    var props = (_props = {}, _props[SC_ATTR] = stringifyNames(names), _props[SC_VERSION_ATTR] = "4.3.1-0", _props);
...
var StyleSheet = function () {
  ...
  StyleSheet.prototype.rehydrate = function rehydrate$$1() {
    ...
    var nodes = document.querySelectorAll('style[' + SC_ATTR + '][' + SC_VERSION_ATTR + '="' + "4.3.1-0" + '"]');
