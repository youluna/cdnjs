(function (global, factory) {
  ...
  function createStylisInstance(options, plugins) {
    ...
    var stylis = new stylis_min(_extends({
      global: false,
      cascade: true,
      keyframe: false,
      prefix: true,
  ...
  function useStyledComponentImpl(forwardedComponent, props, forwardedRef) {
    ...
    var generatedClassName = useInjectedStyle(componentStyle, componentAttrs.length > 0, context, utils, forwardedComponent.warnTooManyClasses);
