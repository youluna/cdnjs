...
import React, { useContext, useMemo, useState, createElement, useDebugValue, useEffect } from 'react';
...
var SC_VERSION = "5.0.0-5.canary-sheet";
...
function useStyledComponentImpl(forwardedComponent, props, forwardedRef) {
  ...
  styledComponentId, attrs.className, generatedClassName !== styledComponentId ? generatedClassName : null).filter(Boolean).join(' '); // $FlowFixMe
