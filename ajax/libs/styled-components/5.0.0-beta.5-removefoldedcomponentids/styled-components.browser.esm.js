...
var SC_VERSION = "5.0.0-beta.5-removefoldedcomponentids";
...
function useStyledComponentImpl(forwardedComponent, props, forwardedRef) {
  ...
  propsForElement.className = Array.prototype.concat(styledComponentId, generatedClassName !== styledComponentId ? generatedClassName : null, props.className, attrs.className).filter(Boolean).join(' ');
