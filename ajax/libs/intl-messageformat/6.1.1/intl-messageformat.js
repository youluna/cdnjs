(function (global, factory) {
    ...
    function peg$parse(input, options) {
        ...
        var peg$c55 = /^[\t-\r \x85\u200E\u200F\u2028\u2029]/;
        var peg$c56 = peg$classExpectation([["\t", "\r"], " ", "\x85", "\u200E", "\u200F", "\u2028", "\u2029"], false, false);
        var peg$c57 = /^[!-\/:-@[-\^`{-~\xA1-\xA7\xA9\xAB\xAC\xAE\xB0\xB1\xB6\xBB\xBF\xD7\xF7\u2010-\u2027\u2030-\u203E\u2041-\u2053\u2055-\u205E\u2190-\u245F\u2500-\u2775\u2794-\u2BFF\u2E00-\u2E7F\u3001-\u3003\u3008-\u3020\u3030\uFD3E\uFD3F\uFE45\uFE46]/;
        var peg$c58 = peg$classExpectation([["!", "/"], [":", "@"], ["[", "^"], "`", ["{", "~"], ["\xA1", "\xA7"], "\xA9", "\xAB", "\xAC", "\xAE", "\xB0", "\xB1", "\xB6", "\xBB", "\xBF", "\xD7", "\xF7", ["\u2010", "\u2027"], ["\u2030", "\u203E"], ["\u2041", "\u2053"], ["\u2055", "\u205E"], ["\u2190", "\u245F"], ["\u2500", "\u2775"], ["\u2794", "\u2BFF"], ["\u2E00", "\u2E7F"], ["\u3001", "\u3003"], ["\u3008", "\u3020"], "\u3030", "\uFD3E", "\uFD3F", "\uFE45", "\uFE46"], false, false);
        var peg$c59 = peg$otherExpectation("optional whitespace");
        var peg$c60 = /^[0-9]/;
        var peg$c61 = peg$classExpectation([["0", "9"]], false, false);
        var peg$c62 = function (digits) {
            return parseInt(digits.join(''), 10);
        };
        var peg$c64 = peg$otherExpectation("double apostrophes");
        var peg$c65 = "''";
        var peg$c66 = peg$literalExpectation("''", false);
        var peg$c67 = function () { return "'"; };
        var peg$c68 = /^[{}]/;
        var peg$c69 = peg$classExpectation(["{", "}"], false, false);
        var peg$c70 = function (escapedChar, quotedChars) {
            return escapedChar + quotedChars.replace("''", "'");
        };
        var peg$c71 = /^[^{}]/;
        var peg$c72 = peg$classExpectation(["{", "}"], true, false);
        var peg$c73 = peg$otherExpectation("keyword");
        var peg$currPos = 0;
        var peg$savedPos = 0;
