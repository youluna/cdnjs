(function (global, factory) {
    ...
    */
    ...
    function formatPatterns(els, locales, formatters, formats, values, 
    // For debugging
    originalMessage) {
    ...
    var IntlMessageFormat = /** @class */ (function () {
        function IntlMessageFormat(message, locales, overrideFormats, opts) {
            ...
            this.format = function (values) {
                return formatPatterns(_this.ast, _this.locale, _this.formatters, _this.formats, values, _this.message);
            };
