  ...
  */
    ...
    */
     ...
     */
				...
				setTimeout(function () {
					if (!wasNoOp) {
						window.dispatchEvent(new CustomEvent$1("single-spa:app-change"));
					}

					window.dispatchEvent(new CustomEvent$1("single-spa:routing-event"));
				});
			}
