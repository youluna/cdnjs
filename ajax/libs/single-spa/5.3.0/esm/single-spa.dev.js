...
function validateRegisterWithConfig(config) {
  ...
  if (invalidKeys.length !== 0) throw Error(formatErrorMessage(30,  `The configuration object accepts only: ${validKeys.join(", ")}. Invalid keys: ${invalidKeys.join(", ")}.`));
