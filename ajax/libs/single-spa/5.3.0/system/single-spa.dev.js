	...
	return {
		execute: function () {
			...
			function validateRegisterWithConfig(config) {
			  if (Array.isArray(config) || config === null) throw Error(formatErrorMessage(31,  "Configuration object can't be an Array or null!"));
			  ...
			  if (invalidKeys.length !== 0) throw Error(formatErrorMessage(30,  "The configuration object accepts only: ".concat(validKeys.join(", "), ". Invalid keys: ").concat(invalidKeys.join(", "), ".")));
