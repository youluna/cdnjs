...
var tippy = (function (Popper) {
  ...
  function createCreateSingletonWithPlugins(outerPlugins) {
    return function (tippyInstances, optionalProps, innerPlugins) {
      ...
      return createSingleton(tippyInstances, optionalProps, [].concat(outerPlugins, innerPlugins));
    };
  }
  ...
  function createDelegateWithPlugins(outerPlugins) {
    return function (targets, props, innerPlugins) {
      if (innerPlugins === void 0) {
        innerPlugins = [];
      }

      return delegate(targets, props, [].concat(outerPlugins, innerPlugins));
    };
  }
  ...
  var plugins = [animateFill, followCursor, inlinePositioning, sticky];
  var extendedTippy = createTippyWithPlugins(plugins);
