...
plugins) {
  ...
  plugins = index.defaultProps.plugins.concat(optionalProps.plugins || plugins);
  ...
  return index.tippy(document.createElement('div'), props);
}
...
plugins) {
  ...
  plugins = index.defaultProps.plugins.concat(props.plugins || plugins);
  var listeners = [];
