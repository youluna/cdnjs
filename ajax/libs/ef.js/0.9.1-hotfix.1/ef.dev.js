(function (global, factory) {
	...
	var createTextFragment = function (value) {
	...
	var createElement$1 = function (tag, attrs) {
		...
		if (tag === Fragment) { return new EFBaseComponent([{t: 0} ].concat( children.map(createTextFragment))) }
