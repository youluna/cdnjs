(function (global, factory) {
    ...
    function mountFunctionalComponent(vNode, parentDOM, context, isSVG, nextNode, lifecycle) {
        ...
        var props = vNode.props || EMPTY_OBJ;
        var ref = vNode.ref;
        mount((vNode.children = handleComponentInput(vNode.flags & 32768 /* ForwardRef */ ? type.render(props, ref, context) : type(props, context))), parentDOM, context, isSVG, nextNode, lifecycle);
    ...
    function patchFunctionalComponent(lastVNode, nextVNode, parentDOM, context, isSVG, nextNode, lifecycle) {
        ...
        if (shouldUpdate !== false) {
            ...
            var nextInput = handleComponentInput(nextVNode.flags & 32768 /* ForwardRef */ ? type.render(nextProps, nextRef, context) : type(nextProps, context));
