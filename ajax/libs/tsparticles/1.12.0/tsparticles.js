    ...
    if (data !== undefined) {
      if (data.color !== undefined) {
        if (typeof data.color === "string") {
          ...
          if (typeof color.value === "string") {
            this.opacity = (_b = ColorUtils_ColorUtils.stringToAlpha(color.value)) !== null && _b !== void 0 ? _b : this.opacity;
          }
        }
      }
...
class StarDrawer_StartDrawer extends PolygonDrawerBase {
  getSidesData(particle, radius) {
    var _a, _b;
...
// CONCATENATED MODULE: ./dist/Classes/ShapeDrawers/HeartDrawer.js
class HeartDrawer {
  draw(context, particle, radius) {
    const x = -radius / 2;
    const y = -radius / 2;
...
class Main_Main {
  constructor() {
    ...
    ShapeUtils.addShapeDrawer(ShapeType.star, new StarDrawer_StartDrawer());
