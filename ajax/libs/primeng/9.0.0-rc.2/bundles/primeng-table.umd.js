        ...
        ScrollableView.prototype.setScrollHeight = function () {
            if (this.scrollHeight && this.scrollBodyViewChild && this.scrollBodyViewChild.nativeElement) {
                if (this.scrollHeight.indexOf('%') !== -1) {
                    ...
                    if (this.frozen && this.scrollableSiblingBody && dom.DomHandler.getOuterWidth(this.scrollableSiblingBody) < dom.DomHandler.getOuterWidth(this.scrollableSiblingBody.children[0]))
