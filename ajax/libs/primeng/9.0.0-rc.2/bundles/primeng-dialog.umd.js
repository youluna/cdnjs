(function (global, factory) {
    ...
    var Dialog = /** @class */ (function () {
        ...
        Dialog.prototype.positionOverlay = function () {
            ...
            if (dom.DomHandler.getOuterHeight(this.container) + this.contentViewChild.nativeElement.scrollHeight - this.contentViewChild.nativeElement.clientHeight > viewport.height) {
        ...
        Dialog.prototype.center = function () {
            var elementWidth = dom.DomHandler.getOuterWidth(this.container);
            var elementHeight = dom.DomHandler.getOuterHeight(this.container);
            if (elementWidth == 0 && elementHeight == 0) {
                this.container.style.visibility = 'hidden';
                this.container.style.display = 'block';
                elementWidth = dom.DomHandler.getOuterWidth(this.container);
                elementHeight = dom.DomHandler.getOuterHeight(this.container);
            ...
            if (this.mask) {
                ...
                if (this.blockScroll) {
                    ...
                    for (var i = 0; i < bodyChildren.length; i++) {
                        ...
                        if (dom.DomHandler.hasClass(bodyChild, 'ui-dialog-mask-scrollblocker')) {
