(function (global, factory) {
	...
	var Path = /*#__PURE__*/function (_MapLayer) {
	  ...
	  function Path(props) {
	    ...
	    if (_this.contextValue == null) {
	      _this.contextValue = objectSpread2({}, props.leaflet, {
	...
	var CircleMarker = /*#__PURE__*/function (_Path) {
	  ...
	  createClass(CircleMarker, [{
	    ...
	    value: function createLeafletElement(props) {
	      ...
	      this.contextValue = objectSpread2({}, props.leaflet, {
	        popupContainer: el
	      });
	      return el;
	    }
	...
	var BaseLayer = /*#__PURE__*/function (_ControlledLayer) {
	  ...
	  function BaseLayer(props) {
	    ...
	    _this2.contextValue = objectSpread2({}, props.leaflet, {
	      layerContainer: {
	...
	var Overlay = /*#__PURE__*/function (_ControlledLayer2) {
	  ...
	  function Overlay(props) {
	    ...
	    _this3.contextValue = objectSpread2({}, props.leaflet, {
	      layerContainer: {
	...
	var Map = /*#__PURE__*/function (_MapEvented) {
	  ...
	  createClass(Map, [{
	    ...
	    value: function getFitBoundsOptions(props) {
	      ...
	      return objectSpread2({}, zoomPanOptions, {}, props.boundsOptions);
	    }
	  }, {
	    key: "componentDidMount",
	    value: function componentDidMount() {
	  ...
	  createClass(Pane, [{
	    ...
	    value: function createPane(props) {
	      ...
	      if (map != null && map.createPane != null) {
	        ...
	        this.setState({
	          name: name,
	          context: objectSpread2({}, props.leaflet, {
	            pane: name
	          })
	        }, this.setStyle);
	      }
	...
	var Popup = /*#__PURE__*/function (_DivOverlay) {
	  ...
	  createClass(Popup, [{
	    key: "getOptions",
	    value: function getOptions(props) {
	      return objectSpread2({}, get(getPrototypeOf$1(Popup.prototype), "getOptions", this).call(this, props), {
	        autoPan: false
	      });
	    }
	  }, {
