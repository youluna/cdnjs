...
void 0,void 0))}};q.param=function(a){return"undefined"!==typeof l&&"undefined"!==typeof a?l[a]:l};return q}(window,F);A.withAttr=function(a,c,g){return function(f){c.call(g||this,a in f.currentTarget?f.currentTarget[a]:f.currentTarget.getAttribute(a))}};var X=Q(window);A.render=X.render;A.redraw=F.redraw;A.request=M.request;A.jsonp=M.jsonp;A.parseQueryString=N;A.buildQueryString=H;A.version="1.2.0";A.vnode=w;"undefined"!==typeof module?module.exports=A:window.m=A})();