"use strict";angular.module("ngLocale",[],["$provide",function(a){var u="one",n="other";function t(a,e){var i=e;void 0===i&&(i=Math.min(function(a){var e=(a+="").indexOf(".");return-1==e?0:a.length-e-1}(a),3));var m=Math.pow(10,i);return{v:i,f:(a*m|0)%m}}a.value("$locale",{DATETIME_FORMATS:{AMPMS:["Asubuhi","Mchana"],DAY:["Jumapili","Jumatatu","Jumanne","Jumatano","Alhamisi","Ijumaa","Jumamosi"],ERANAMES:["Kabla ya Kristo","Baada ya Kristo"],ERAS:["KK","BK"],FIRSTDAYOFWEEK:0,MONTH:["Januari","Februari","Machi","Aprili","Mei","Juni","Julai","Agosti","Septemba","Oktoba","Novemba","Desemba"],SHORTDAY:["Jumapili","Jumatatu","Jumanne","Jumatano","Alhamisi","Ijumaa","Jumamosi"],SHORTMONTH:["Jan","Feb","Mac","Apr","Mei","Jun","Jul","Ago","Sep","Okt","Nov","Des"],STANDALONEMONTH:["Januari","Februari","Machi","Aprili","Mei","Juni","Julai","Agosti","Septemba","Oktoba","Novemba","Desemba"],WEEKENDRANGE:[5,6],fullDate:"EEEE, d MMMM y",longDate:"d MMMM y",medium:"d MMM y HH:mm:ss",mediumDate:"d MMM y",mediumTime:"HH:mm:ss",short:"dd/MM/y HH:mm",shortDate:"dd/MM/y",shortTime:"HH:mm"},NUMBER_FORMATS:{CURRENCY_SYM:"TSh",DECIMAL_SEP:".",GROUP_SEP:",",PATTERNS:[{gSize:3,lgSize:3,maxFrac:3,minFrac:0,minInt:1,negPre:"-",negSuf:"",posPre:"",posSuf:""},{gSize:3,lgSize:3,maxFrac:0,minFrac:0,minInt:1,negPre:"-¤",negSuf:"",posPre:"¤",posSuf:""}]},id:"sw-tz",localeID:"sw_TZ",pluralCat:function(a,e){var i=0|a,m=t(a,e);return 1==i&&0==m.v?u:n}})}]);