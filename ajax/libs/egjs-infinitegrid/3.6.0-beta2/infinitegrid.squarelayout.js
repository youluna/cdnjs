    ...
    function () {
      ...
      __proto.sync = function (items) {
        ...
        removed.forEach(function (removedIndex) {
          _this.removeGroup(removedIndex);
        });
        ordered.forEach(function (_a, i) {
          var prevIndex = _a[0],
              nextIndex = _a[1];
          var group = groups.splice(prevIndex, 1)[0];
        ...
        maintained.forEach(function (_a) {
          ...
          _this.syncItems(groups[toIndex].items, newGroups[toIndex].items, toIndex);
        });
        return result;
      };
      ...
      __proto.syncItems = function (items, newItems, groupIndex) {
        var _this = this;
        ...
        removed.forEach(function (removedIndex) {
          _this.remove(groupIndex, removedIndex);
        });
        ordered.forEach(function (_a) {
          var prevIndex = _a[0],
              nextIndex = _a[1];
          var item = items.splice(prevIndex, 1)[0];
    ...
    */
    ...
    function (_super) {
      ...
      */
      ...
      InfiniteGrid.VERSION = "3.5.5-snapshot";
      return InfiniteGrid;
    }(Component);
